...
public final class Constants {
    ...
    // FRONT LEFT : Florida
    public static final int FRONT_LEFT_DRIVE_MOTOR = 20;
    public static final int FRONT_LEFT_STEER_MOTOR = 21;
    public static final int FRONT_LEFT_STEER_ENCODER = 11;
    ...
    // FRONT RIGHT : France
    public static final int FRONT_RIGHT_DRIVE_MOTOR = 22;
    public static final int FRONT_RIGHT_STEER_MOTOR = 23;
    ...
    public static final int BACK_RIGHT_STEER_MOTOR = 25;
    public static final int BACK_RIGHT_STEER_ENCODER = 13;
    ...
    // BACK LEFT : Real Life
    public static final int BACK_LEFT_DRIVE_MOTOR = 26;
    public static final int BACK_LEFT_STEER_MOTOR = 27;
    public static final int BACK_LEFT_STEER_ENCODER = 14;
